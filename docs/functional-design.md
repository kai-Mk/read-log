...
| 画面名             | 種別     | URLパス                  | 概要                                   |
| ------------------ | -------- | ------------------------ | -------------------------------------- |
| トップページ       | ページ   | /                        | サービス紹介、マイ書庫作成             |
| マイ書庫           | ページ   | /library/:libraryId      | 本の一覧表示、ステータス別ビュー       |
| 本の登録           | モーダル | -                        | ISBN検索または手動で本を登録           |
| 本の詳細           | モーダル | -                        | 本の詳細表示、メモ管理                 |
| 本の編集           | モーダル | -                        | 本の情報編集                           |
...
| 「編集」ボタンをクリック         | 本の編集モーダルを表示                       |
| 「削除」ボタンをクリック         | 確認ダイアログが表示される                   |
| 削除を確定                       | 本が削除され、モーダルを閉じる               |
| 閉じるボタンをクリック           | モーダルを閉じる                             |
...
| アクション                       | 結果                                         |
| -------------------------------- | -------------------------------------------- |
| フォームを編集して保存           | 本の情報が更新され、詳細モーダルに戻る       |
| キャンセルをクリック             | 詳細モーダルに戻る                           |
