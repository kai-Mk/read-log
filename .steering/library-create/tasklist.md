...
- [ ] features/library/services/libraryService.ts テスト作成
- [ ] features/library/services/libraryService.ts 実装

## Phase 5: Frontend - Hooks

- [ ] hooks/useCreateLibrary.ts テスト作成
